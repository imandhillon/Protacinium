...
'rythmic direction' (I'm no music theorist :P) and what not and keep stats on what
...
for the tools I would end up with in it. 
	http://nifty.stanford.edu/2010/zingaro-song-generator/assignment.html
		------------------
Switching over to tensorflow. Maybe to pure numpy at some point. If one is more efficient, use it.
Doing the numpy thing so I can learn regardless.
		------------------
Add functionality to sound swap. Described below.
		------------------
Add cnn to detect 'plagiarism'. Allow user to rate output. Keep stats on user preferences.
		------------------
'''
